...
pcall(require("ffi.GridEntity.GridEntity"))
pcall(require("ffi.GridEntity.GridEntityDecoration"))
pcall(require("ffi.GridEntity.GridEntityDoor"))
pcall(require("ffi.GridEntity.GridEntityFire"))
pcall(require("ffi.GridEntity.GridEntityGravity"))
pcall(require("ffi.GridEntity.GridEntityLock"))
pcall(require("ffi.GridEntity.GridEntityPit"))
pcall(require("ffi.GridEntity.GridEntityPoop"))
pcall(require("ffi.GridEntity.GridEntityPressurePlate"))
pcall(require("ffi.GridEntity.GridEntityRock"))
pcall(require("ffi.GridEntity.GridEntitySpikes"))
pcall(require("ffi.GridEntity.GridEntityStairs"))
pcall(require("ffi.GridEntity.GridEntityStatue"))
pcall(require("ffi.GridEntity.GridEntityTeleporter"))
pcall(require("ffi.GridEntity.GridEntityTNT"))	
