ffi.cdef[[
bool L_Room_CheckLine(Vector*, Vector*, int, int, bool, bool, Vector*);
bool L_Room_DamageGrid(int, int);
bool L_Room_DestroyGrid(int, bool, bool);
void L_Room_EmitBloodFromWalls(int, int);
Vector* L_Room_FindFreePickupSpawnPosition(Vector*, float, bool, bool);
Vector* L_Room_FindFreeTilePosition(Vector*, float);
...
int L_Room_GetClampedGridIndex(Vector*);
Vector* L_Room_GetClampedPosition(Vector*, float);
int L_Room_GetDecorationSeed();
int L_Room_GetDeliriumDistance();
float L_Room_GetDevilRoomChance();
GridEntity_Door* L_Room_GetDoor(int);
Vector* L_Room_GetDoorSlotPosition(int);
int L_Room_GetDungeonRockIdx();
float L_Room_GetEnemyDamageInflicted();
EntityList* L_Room_GetEntities();
int L_Room_GetFrameCount();
int L_Room_GetGridCollision(int);
int L_Room_GetGridCollisionAtPos(Vector*);
GridEntity* L_Room_GetGridEntity(int);
GridEntity* L_Room_GetGridEntityFromPos(Vector*);
int L_Room_GetGridHeight();
int L_Room_GetGridIndex(Vector*);
int L_Room_GetGridPath(int);
int L_Room_GetGridPathFromPos(Vector*);
Vector* L_Room_GetGridPosition(int);
int L_Room_GetGridSize();
int L_Room_GetGridWidth();
Vector* L_Room_GetLaserTarget(Vector*, Vector*);
...
Vector* L_Room_GetRandomPosition(float);
int L_Room_GetRandomTileIndex(int);
...
unsigned int L_Room_GetSeededCollectible(int, bool);
...
bool L_Room_IsDoorSlotAllowed(int);
...
bool L_Room_IsPositionInRoom(Vector*, float);
bool L_Room_IsSacrificeDone();
void L_Room_KeepDoorsClosed();
void L_Room_MamaMegaExplosion(Vector*);
void L_Room_PlayMusic();
void L_Room_RemoveDoor(int);
void L_Room_RemoveGridEntity(int, int, bool);
void L_Room_Render();
void L_Room_RespawnEnemies();
Vector* L_Room_ScreenWrapPosition(Vector*, float);
void L_Room_SetAmbushDone(bool);
void L_Room_SetBrokenWatchState(int);
void L_Room_SetCardAgainstHumanity();
void L_Room_SetClear(bool);
void L_Room_SetFirstEnemyDead(bool);
void L_Room_SetFloorColor(ColorMod*);
bool L_Room_SetGridPath(int, int);
void L_Room_SetRedHeartDamage();
void L_Room_SetSacrificeDone(bool);
void L_Room_SetSlowDown(int);
void L_Room_SetWallColor(ColorMod*);
void L_Room_ShopReshuffle(bool, bool);
void L_Room_ShopRestockFull();
void L_Room_ShopRestockPartial();
void L_Room_SpawnClearAward();
bool L_Room_SpawnGridEntity(int, unsigned int, unsigned int, unsigned int, unsigned int);
void L_Room_StopRain();
void L_Room_TriggerClear(bool);
bool L_Room_TryMakeBridge(GridEntity*, GridEntity*);
bool L_Room_TrySpawnBlueWombDoor(bool, bool, bool);
bool L_Room_TrySpawnBossRushDoor(bool, bool);
bool L_Room_TrySpawnBrokenShovel();
bool L_Room_TrySpawnDevilRoomDoor(bool, bool);
bool L_Room_TrySpawnMegaSatanRoomDoor(bool);
bool L_Room_TrySpawnSecretExit(bool, bool);
bool L_Room_TrySpawnSecretShop(bool);
bool L_Room_TrySpawnSpecialQuestDoor();
bool L_Room_TrySpawnTheVoidDoor(bool);
void L_Room_TurnGold();
void L_Room_Update();
Vector* L_Room_WorldToScreenPosition(Vector*);
]]
