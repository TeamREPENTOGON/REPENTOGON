            ...
            case ImGuiInputTextFlags_CallbackEdit:
            {
                ...
                if (cmdlets.size() >= 2 || (cmdlets.size() < 3 && std::isspace(static_cast<unsigned char>(strBuf.back())))) {
                    ...
                    switch (command->autocompleteType) {
                        ...
                        case GRID: {
                            entries = {
                                AutocompleteEntry("0.10", "Decoration A"),
                                AutocompleteEntry("0.20", "Decoration B"),
                                AutocompleteEntry("0.30", "Decoration C"),
                                AutocompleteEntry("1000", "Rock"),
                                AutocompleteEntry("1000.1000", "Rock (connecting)"),
                                ...
                                AutocompleteEntry("1400", "Fire Place (unused)"),
                                AutocompleteEntry("1410", "Red Fire Place (unused)"),
                                ...
                                AutocompleteEntry("1930.100", "Sanguine Bond Spikes"),
                                AutocompleteEntry("1931", "Retractable Spikes"),
                                AutocompleteEntry("1931.1", "Retractable Spikes (down 1/5)"),
                                AutocompleteEntry("1931.2", "Retractable Spikes (down 2/5)"),
                                AutocompleteEntry("1931.3", "Retractable Spikes (down 3/5)"),
                                AutocompleteEntry("1931.4", "Retractable Spikes (down 4/5)"),
                                AutocompleteEntry("1931.5", "Retractable Spikes (down 5/5)"),
                                AutocompleteEntry("1931.6", "Retractable Spikes (up 1/5)"),
                                AutocompleteEntry("1931.7", "Retractable Spikes (up 2/5)"),
                                AutocompleteEntry("1931.8", "Retractable Spikes (up 3/5)"),
                                AutocompleteEntry("1931.9", "Retractable Spikes (up 4/5)"),
                                AutocompleteEntry("1931.10", "Retractable Spikes (up 5/5)"),
                                ...
                                AutocompleteEntry("9100.1", "Great Gideon Crawlspace"),
                                AutocompleteEntry("9100.2", "Secret Shop Crawlspace"),
                                AutocompleteEntry("9100.3", "Starting Room Crawlspace"),
