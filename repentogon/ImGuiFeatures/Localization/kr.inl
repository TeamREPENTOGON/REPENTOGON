...
I(CONSOLE_DEBUG_HINT_13, u8"격자 충돌점 표시")
I(CONSOLE_DEBUG_HINT_14, u8"Lua 메모리 사용량 표시")

I(CONSOLE_COMBO_HINT_0, u8"보물방")
I(CONSOLE_COMBO_HINT_1, u8"상점")
I(CONSOLE_COMBO_HINT_2, u8"보스방")
I(CONSOLE_COMBO_HINT_3, u8"악마방")
I(CONSOLE_COMBO_HINT_4, u8"천사방")
I(CONSOLE_COMBO_HINT_5, u8"비밀방")
I(CONSOLE_COMBO_HINT_6, u8"책방")
I(CONSOLE_COMBO_HINT_7, u8"도전방")
...
I(CONSOLE_COMBO_HINT_12, u8"저주방")
...
I(CONSOLE_GRID_RAIL_PIT_HORIZONTAL, u8"Rail Pit (horizontal)"                       u8" 레일 구덩이 (가로)")
I(CONSOLE_GRID_RAIL_PIT_VERTICAL, u8"Rail Pit (vertical)"                           u8" 레일 구덩이 (세로)")
I(CONSOLE_GRID_RAIL_PIT_DOWN_TO_RIGHT, u8"Rail Pit (down-to-right)"                 u8" 레일 구덩이 (우-하)")
I(CONSOLE_GRID_RAIL_PIT_DOWN_TO_LEFT, u8"Rail Pit (down-to-left)"                   u8" 레일 구덩이 (좌-하)")
I(CONSOLE_GRID_RAIL_PIT_UP_TO_RIGHT, u8"Rail Pit (up-to-right)"                     u8" 레일 구덩이 (우-상)")
I(CONSOLE_GRID_RAIL_PIT_UP_TO_LEFT, u8"Rail Pit (up-to-left)"                       u8" 레일 구덩이 (좌-상)")
I(CONSOLE_GRID_RAIL_PIT_CROSSROAD, u8"Rail Pit (crossroad)"                         u8" 레일 구덩이 (교차)")
I(CONSOLE_GRID_RAIL_PIT_CART_LEFT, u8"Rail Pit (cart-left)"                         u8" 레일 구덩이 (좌-카트)")
I(CONSOLE_GRID_RAIL_PIT_CART_UP, u8"Rail Pit (cart-up)"                             u8" 레일 구덩이 (상-카트)")
I(CONSOLE_GRID_RAIL_PIT_CART_RIGHT, u8"Rail Pit (cart-right)"                       u8" 레일 구덩이 (우-카트)")
I(CONSOLE_GRID_RAIL_PIT_CART_DOWN, u8"Rail Pit (cart-down)"                         u8" 레일 구덩이 (하-카트)")
...
I(CONSOLE_GRID_CRAWLSPACE, u8"Crawlspace"                                           u8" 사다리방")
I(CONSOLE_GRID_CRAWLSPACE_GIDEON_DUNGEON, u8"Crawlspace (Gideon dungeon)"           u8" 사다리방 (기드온 던전)")
I(CONSOLE_GRID_CRAWLSPACE_SECRET_SHOP, u8"Crawlspace (secret shop)"                 u8" 사다리방 (암시장)")
I(CONSOLE_GRID_CRAWLSPACE_STARTING_ROOM, u8"Crawlspace (starting room)"             u8" 사다리방 (시작방)")
...
I(OPT_JACOB_ESAU_CONTROLS_MODE, u8"야곱 & 에사우 조작")
I(OPT_ASCENT_VOICEOVER, u8"아빠의 쪽지 음성")

I(OPT_HUD_HUDS, u8"HUD")
I(OPT_HUD_HUD_OFFSET, u8"HUD 오프셋")
I(OPT_HUD_FOUND_HUD, u8"발견 HUD")
...
I(OPT_CONSOLE_FADED_CONSOLE_DISPLAY, u8"투명 콘솔")
...
I(OPT_VIS_ENABLE_WATER_SURFACE_RENDERING, u8"물 표면 렌더링 활성화")
I(OPT_VIS_ENABLE_WATER_SURFACE_RENDERING_MARK, u8"물 표면 설정 변경 시 필요합니다.")
I(OPT_VIS_WATER_SURFACE, u8"물 표면")
...
I(OPT_MISC_ENABLE_CTRL_HOTPLUG, u8"컨트롤러 핫플러그 활성화")
...
I(OPT_REPENTOGON_SYNC_OPTIONS, u8"바닐라 게임 설정과 동기화")
I(OPT_REPENTOGON_SYNC_OPTIONS_MARK, u8"바닐라와 REPENTOGON이 공유하는 게임 설정에 동일한 값을 사용합니다. REPENTOGON에서 별도의 설정을 사용하려면 이 옵션을 비활성화하세요.")
I(OPT_REPENTOGON_SYNC_MODS_ENABLED, u8"'Mods Enabled' 설정 동기화")
I(OPT_REPENTOGON_SYNC_MODS_ENABLED_MARK, u8"비활성화 시 바닐라에선 모드를 비활성화하되 REPENTOGON에선 활성화할 수 있으며, 다른 모든 옵션은 계속 동기화됩니다.")
I(OPT_REPENTOGON_BETTER_VOID_GEN, u8"더 나은 공허 생성")
I(OPT_REPENTOGON_BETTER_VOID_GEN_MARK, u8"공허가 대체 경로를 포함해 해금된 모든 층에서 방을 가져옵니다.")
...
I(OPT_REPENTOGON_QUICKER_ROOM_CLEAR_MARK, u8"방 클리어 후 문이 열리고 보상이 생성되는 속도를 빠르게 합니다. 보스방은 보스 사망 애니메이션이 끝날 때까지 기다려야 합니다.")
...
I(OPT_SAVE_MANAGEMENT, u8"세이브 관리")
I(OPT_SAVE_MANAGEMENT_DISABLED_REASON, u8"세이브 파일이 현재 열려 있기 때문에 일부 옵션/유틸리티가 비활성화되었습니다.")
I(OPT_SAVE_MANAGEMENT_ENABLE_SAVE_SYNCING, u8"바닐라와 REPENTOGON 간 진행 상황을 자동으로 동기화합니다")
I(OPT_SAVE_MANAGEMENT_ENABLE_SAVE_SYNCING_MARK, u8"활성화 시 REPENTOGON에서 플레이하며 달성한 모든 도전 과제/진행 상황은 바닐라에도 반영되며, 그 반대의 경우도 마찬가지입니다.")
I(OPT_SAVE_MANAGEMENT_SYNC, u8"REPENTOGON과 바닐라 세이브 동기화")
I(OPT_SAVE_MANAGEMENT_SYNC_MARK, u8"REPENTOGON 세이브와 바닐라 리펜턴스+ 세이브 간 동기화를 진행하여 서로 최신 상태를 유지합니다.")
I(OPT_SAVE_MANAGEMENT_SYNC_PROMPT, u8"REPENTOGON과 바닐라 리펜턴스+ 세이브 파일의 도전 과제 & 진행 상황을 동기화합니다.\n\n계속하시겠습니까?")
I(OPT_SAVE_MANAGEMENT_IMPORT_EXPORT, u8"도전 과제 % 진행 상황 가져오기/내보내기")
I(OPT_SAVE_MANAGEMENT_SAVE_SLOT, u8"슬롯")
I(OPT_SAVE_MANAGEMENT_ALL_SLOTS, u8"모두")
I(OPT_SAVE_MANAGEMENT_IMPORT_FROM_REPENTANCE, u8"리펜턴스에서 가져오기")
I(OPT_SAVE_MANAGEMENT_IMPORT_FROM_REPENTANCE_MARK, u8"리펜턴스로부터 누락된 모든 도전 과제/진행 상황을 리펜턴스+로 가져옵니다.")
I(OPT_SAVE_MANAGEMENT_IMPORT_FROM_REPENTANCE_PROMPT, u8"기존 리펜턴스 세이브 파일로부터 누락된 모든 도전 과제/진행 상황을 REPENTOGON/리펜턴스+ 세이브 파일로 가져옵니다.\n\n계속하시겠습니까?")
I(OPT_SAVE_MANAGEMENT_EXPORT_TO_REPENTANCE, u8"리펜턴스로 내보내기")
I(OPT_SAVE_MANAGEMENT_EXPORT_TO_REPENTANCE_MARK, u8"리펜턴스+에서 해금한 모든 도전 과제를 리펜턴스 세이브 파일에서 해금합니다.")
I(OPT_SAVE_MANAGEMENT_EXPORT_TO_REPENTANCE_PROMPT, u8"REPENTOGON/리펜턴스+ 세이브 파일의 새 도전 과제/진행 상황을 기존 리펜턴스 세이브 파일로 내보냅니다.\n\n계속하시겠습니까?")
I(OPT_SAVE_MANAGEMENT_SUCCESS, u8"완료!")
I(OPT_SAVE_MANAGEMENT_FAILED, u8"실패. 자세한 정보는 'repentogon.log'를 확인하세요.")
I(OPT_SAVE_MANAGEMENT_SUCCESS_NOT_FOUND, u8"완료, 일부 파일을 찾지 못했습니다.")
I(OPT_SAVE_MANAGEMENT_NOT_FOUND, u8"세이브 파일을 찾지 못했습니다.")
...
I(OPT_JACOB_ESAU_CONTROLS_MODES_CLASSIC, u8"클래식")
I(OPT_JACOB_ESAU_CONTROLS_MODES_BETTER, u8"새 방식")
...
I(HELP_MENU_CTRL_PLAYSTATION_TEXT, u8"DualShock4 컨트롤러 조작법")

I(HELP_MENU_CTRL_XBOX, u8"Xbox")
I(HELP_MENU_CTRL_XBOX_TEXT, u8"Xbox 컨트롤러 조작법")

I(HELP_MENU_CTRL_SWITCH, u8"Switch")
I(HELP_MENU_CTRL_SWITCH_TEXT, u8"Joy-Con 컨트롤러 조작법")
...
I(ERROR_SAVE_SYNC_FAILED, u8"REPENTOGON 세이브 파일 동기화 실패.\n\n진행 상황은 손실되지 않습니다. 단, REPENTOGON에서의 진행 상황은 바닐라에서 플레이할 때 일시적으로 반영되지 않을 수 있으며, 그 반대의 경우도 마찬가지입니다.\n")
I(FATAL_SAVE_FILE_WRONG_ACHIEVEMENTS, u8"치명적인 오류: 잘못된 수의 도전 과제가 포함된 세이브 파일을 불러오려 시도했습니다! 데이터 손상을 방지하기 위해 종료합니다!\n")
I(FATAL_SAVE_FILE_WRONG_NAME, u8"치명적인 오류: 잘못된 세이브 파일을 불러오려 시도했습니다! 데이터 손상을 방지하기 위해 종료합니다!\n")
I(ERROR_OPTIONS_FILE_READONLY, u8"다음 파일이 \"읽기 전용\"으로 설정돼있습니다! 바닐라와 REPENTOGON 간 동기화에 문제가 발생할 수 있습니다. 다음 파일/디렉토리의 속성을 확인하고 수정하세요:\n")
