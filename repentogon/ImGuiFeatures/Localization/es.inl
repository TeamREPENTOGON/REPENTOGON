...
I(OPT_CONSOLE_FADED_CONSOLE_DISPLAY, u8"Pantalla de Consola traslucidas")
...
I(OPT_MISC_ENABLE_CTRL_HOTPLUG, u8"Habilitar Conexión en Caliente(Hotplug)")
...
I(HELP_EGG_REACH_THE_HEAVEN, u8"Sigues ascendiendo!\nHas alcanzado los cielos.")
