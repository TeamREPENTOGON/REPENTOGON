...
I(CONSOLE_CUTSCENE_HELP, u8"Immediately plays the specified cutscene.\nExample:\n(cutscene 1) will immediately play the game's intro.")
...
I(OPT_CONSOLE_FADED_CONSOLE_DISPLAY, u8"Faded Console Display")
...
I(OPT_MISC_ENABLE_CTRL_HOTPLUG, u8"Enable Control Hotplug")
