...
I(CONSOLE_FORCEIMPORT_DESC, u8"[实验性] 强制从过去的DLC导入一个存档槽。")
I(CONSOLE_FORCEIMPORT_HELP, u8"需要一个参数，存档槽位ID。")

I(CONSOLE_STAGE_BLUE_WOMB, u8"???/蓝子宫")
I(CONSOLE_STAGE_HOME_DAY, u8"家（白天）")
I(CONSOLE_STAGE_HOME_NIGHT, u8"家（夜晚）")

// About this little trick for translators:
// two consecutive strings mean a complete concatenated string.
// e.g.: u8"AAA" u8"BBB" means u8"AAABBB"
I(CONSOLE_GRID_DECORATION_A,                    u8"Decoration A"                        u8" 地面装饰 A"               )
I(CONSOLE_GRID_DECORATION_B,                    u8"Decoration B"                        u8" 地面装饰 B"               )
I(CONSOLE_GRID_DECORATION_C,                    u8"Decoration C"                        u8" 地面装饰 C"               )
I(CONSOLE_GRID_ROCK,                            u8"Rock"                                u8" 石头"                     )
I(CONSOLE_GRID_ROCK_CONNECTING,                 u8"Rock (connecting)"                   u8" 石头 (过渡)"              )
I(CONSOLE_GRID_BOMB_ROCK,                       u8"Bomb Rock"                           u8" 炸弹石头"                 )
I(CONSOLE_GRID_ALT_ROCK,                        u8"Alt Rock"                            u8" 特殊石头"                 )
I(CONSOLE_GRID_TINTED_ROCK,                     u8"Tinted Rock"                         u8" 标记石头"                 )
I(CONSOLE_GRID_MARKED_SKULL,                    u8"Marked Skull"                        u8" 标记头骨"                 )
I(CONSOLE_GRID_EVENT_ROCK,                      u8"Event Rock"                          u8" 事件石头"                 )
I(CONSOLE_GRID_SPIKED_ROCK,                     u8"Spiked Rock"                         u8" 刺石头"                   )
I(CONSOLE_GRID_FOOLS_GOLD_ROCK,                 u8"Fool's Gold Rock"                    u8" 愚人金石头"               )
I(CONSOLE_GRID_TNT,                             u8"TNT"                                 u8" 炸药桶"                   )
I(CONSOLE_GRID_FIRE_PLACE,                      u8"Fire Place"                          u8" 火堆"                     )
I(CONSOLE_GRID_RED_FIRE_PLACE,                  u8"Red Fire Place"                      u8" 红色火堆"                 )
I(CONSOLE_GRID_RED_POOP,                        u8"Red Poop"                            u8" 红大便"                   )
I(CONSOLE_GRID_RAINBOW_POOP,                    u8"Rainbow Poop"                        u8" 彩虹大便"                 )
I(CONSOLE_GRID_CORNY_POOP,                      u8"Corny Poop"                          u8" 玉米大便"                 )
I(CONSOLE_GRID_GOLDEN_POOP,                     u8"Golden Poop"                         u8" 金大便"                   )
I(CONSOLE_GRID_BLACK_POOP,                      u8"Black Poop"                          u8" 黑大便"                   )
I(CONSOLE_GRID_WHITE_POOP,                      u8"White Poop"                          u8" 白大便"                   )
I(CONSOLE_GRID_GIANT_POOP,                      u8"Giant Poop"                          u8" 巨型大便"                 )
I(CONSOLE_GRID_POOP,                            u8"Poop"                                u8" 大便"                     )
I(CONSOLE_GRID_CHARMING_POOP,                   u8"Charming Poop"                       u8" 友好大便"                 )
I(CONSOLE_GRID_BLOCK,                           u8"Block"                               u8" 方块"                     )
I(CONSOLE_GRID_PILLAR,                          u8"Pillar"                              u8" 柱子"                     )
I(CONSOLE_GRID_SPIKES,                          u8"Spikes"                              u8" 地刺"                     )
I(CONSOLE_GRID_SANGUINE_BOND_SPIKES,            u8"Sanguine Bond Spikes"                u8" 血色羁绊尖刺"             )
I(CONSOLE_GRID_RETRACTABLE_SPIKES,              u8"Retractable Spikes"                  u8" 伸缩地刺"                 )
I(CONSOLE_GRID_RETRACTABLE_SPIKES_DOWN_1_5,     u8"Retractable Spikes (down 1/5)"       u8" 伸缩地刺 (缩1/5)"         )
I(CONSOLE_GRID_RETRACTABLE_SPIKES_DOWN_2_5,     u8"Retractable Spikes (down 2/5)"       u8" 伸缩地刺 (缩2/5)"         )
I(CONSOLE_GRID_RETRACTABLE_SPIKES_DOWN_3_5,     u8"Retractable Spikes (down 3/5)"       u8" 伸缩地刺 (缩3/5)"         )
I(CONSOLE_GRID_RETRACTABLE_SPIKES_DOWN_4_5,     u8"Retractable Spikes (down 4/5)"       u8" 伸缩地刺 (缩4/5)"         )
I(CONSOLE_GRID_RETRACTABLE_SPIKES_DOWN_5_5,     u8"Retractable Spikes (down 5/5)"       u8" 伸缩地刺 (缩5/5)"         )
I(CONSOLE_GRID_RETRACTABLE_SPIKES_UP_1_5,       u8"Retractable Spikes (up 1/5)"         u8" 伸缩地刺 (伸1/5)"         )
I(CONSOLE_GRID_RETRACTABLE_SPIKES_UP_2_5,       u8"Retractable Spikes (up 2/5)"         u8" 伸缩地刺 (伸2/5)"         )
I(CONSOLE_GRID_RETRACTABLE_SPIKES_UP_3_5,       u8"Retractable Spikes (up 3/5)"         u8" 伸缩地刺 (伸3/5)"         )
I(CONSOLE_GRID_RETRACTABLE_SPIKES_UP_4_5,       u8"Retractable Spikes (up 4/5)"         u8" 伸缩地刺 (伸4/5)"         )
I(CONSOLE_GRID_RETRACTABLE_SPIKES_UP_5_5,       u8"Retractable Spikes (up 5/5)"         u8" 伸缩地刺 (伸5/5)"         )
I(CONSOLE_GRID_COBWEB,                          u8"Cobweb"                              u8" 蛛网"                     )
I(CONSOLE_GRID_INVISIBLE_BLOCK,                 u8"Invisible Block"                     u8" 隐形方块"                 )
I(CONSOLE_GRID_PIT,                             u8"Pit"                                 u8" 沟壑"                     )
I(CONSOLE_GRID_FISSURE_SPAWNER,                 u8"Fissure Spawner"                     u8" 骷髅鱼生成器"             )
I(CONSOLE_GRID_EVENT_RAIL,                      u8"Event Rail"                          u8" 事件铁轨"                 )
I(CONSOLE_GRID_EVENT_PIT,                       u8"Event Pit"                           u8" 事件沟壑"                 )
I(CONSOLE_GRID_KEY_BLOCK,                       u8"Key Block"                           u8" 钥匙方块"                 )
I(CONSOLE_GRID_PRESSURE_PLATE,                  u8"Pressure Plate"                      u8" 银按钮"                   )
I(CONSOLE_GRID_REWARD_PLATE,                    u8"Reward Plate"                        u8" 奖励按钮"                 )
I(CONSOLE_GRID_GREED_PLATE,                     u8"Greed Plate"                         u8" 贪婪按钮"                 )
I(CONSOLE_GRID_RAIL_PLATE,                      u8"Rail Plate"                          u8" 铁轨按钮"                 )
I(CONSOLE_GRID_KILL_PLATE,                      u8"Kill Plate"                          u8" 击杀按钮"                 )
I(CONSOLE_GRID_EVENT_PLATE_GROUP_0,             u8"Event Plate (group 0)"               u8" 事件按钮 (组0)"           )
I(CONSOLE_GRID_EVENT_PLATE_GROUP_1,             u8"Event Plate (group 1)"               u8" 事件按钮 (组1)"           )
I(CONSOLE_GRID_EVENT_PLATE_GROUP_2,             u8"Event Plate (group 2)"               u8" 事件按钮 (组2)"           )
I(CONSOLE_GRID_EVENT_PLATE_GROUP_3,             u8"Event Plate (group 3)"               u8" 事件按钮 (组3)"           )
I(CONSOLE_GRID_DEVIL_STATUE,                    u8"Devil Statue"                        u8" 恶魔雕像"                 )
I(CONSOLE_GRID_ANGEL_STATUE,                    u8"Angel Statue"                        u8" 天使雕像"                 )
I(CONSOLE_GRID_RAIL_HORIZONTAL,                 u8"Rail (horizontal)"                   u8" 铁轨(横向)"               )
I(CONSOLE_GRID_RAIL_VERTICAL,                   u8"Rail (vertical)"                     u8" 铁轨(纵向)"               )
I(CONSOLE_GRID_RAIL_DOWN_TO_RIGHT,              u8"Rail (down-to-right)"                u8" 铁轨(下-右)"              )
I(CONSOLE_GRID_RAIL_DOWN_TO_LEFT,               u8"Rail (down-to-left)"                 u8" 铁轨(下-左)"              )
I(CONSOLE_GRID_RAIL_UP_TO_RIGHT,                u8"Rail (up-to-right)"                  u8" 铁轨(上-右)"              )
I(CONSOLE_GRID_RAIL_UP_TO_LEFT,                 u8"Rail (up-to-left)"                   u8" 铁轨(上-左)"              )
I(CONSOLE_GRID_RAIL_CROSSROAD,                  u8"Rail (crossroad)"                    u8" 铁轨(十字)"               )
I(CONSOLE_GRID_RAIL_END_LEFT,                   u8"Rail (end-left)"                     u8" 铁轨(左终止)"             )
I(CONSOLE_GRID_RAIL_END_RIGHT,                  u8"Rail (end-right)"                    u8" 铁轨(右终止)"             )
I(CONSOLE_GRID_RAIL_END_UP,                     u8"Rail (end-up)"                       u8" 铁轨(上终止)"             )
I(CONSOLE_GRID_RAIL_END_DOWN,                   u8"Rail (end-down)"                     u8" 铁轨(下终止)"             )
I(CONSOLE_GRID_RAIL_CART_LEFT,                  u8"Rail (cart-left)"                    u8" 铁轨(左开放)"             )
I(CONSOLE_GRID_RAIL_CART_UP,                    u8"Rail (cart-up)"                      u8" 铁轨(上开放)"             )
I(CONSOLE_GRID_RAIL_CART_RIGHT,                 u8"Rail (cart-right)"                   u8" 铁轨(右开放)"             )
I(CONSOLE_GRID_RAIL_CART_DOWN,                  u8"Rail (cart-down)"                    u8" 铁轨(下开放)"             )
I(CONSOLE_GRID_MINESHAFT_RAIL_HORIZONTAL_1,     u8"Mineshaft Rail (horizontal 1)"       u8" 矿洞铁轨 (横向 1)"        )
I(CONSOLE_GRID_MINESHAFT_RAIL_VERTICAL_1,       u8"Mineshaft Rail (vertical 1)"         u8" 矿洞铁轨 (纵向 1)"        )
I(CONSOLE_GRID_MINESHAFT_RAIL_DOWN_TO_RIGHT_1,  u8"Mineshaft Rail (down-to-right 1)"    u8" 矿洞铁轨 (下-右 1)"       )
I(CONSOLE_GRID_MINESHAFT_RAIL_DOWN_TO_LEFT_1,   u8"Mineshaft Rail (down-to-left 1)"     u8" 矿洞铁轨 (下-左 1)"       )
I(CONSOLE_GRID_MINESHAFT_RAIL_UP_TO_RIGHT_1,    u8"Mineshaft Rail (up-to-right 1)"      u8" 矿洞铁轨 (上-右 1)"       )
I(CONSOLE_GRID_MINESHAFT_RAIL_UP_TO_LEFT_1,     u8"Mineshaft Rail (up-to-left 1)"       u8" 矿洞铁轨 (上-左 1)"       )
I(CONSOLE_GRID_MINESHAFT_RAIL_HORIZONTAL_2,     u8"Mineshaft Rail (horizontal 2)"       u8" 矿洞铁轨 (横向 2)"        )
I(CONSOLE_GRID_MINESHAFT_RAIL_VERTICAL_2,       u8"Mineshaft Rail (vertical 2)"         u8" 矿洞铁轨 (纵向 2)"        )
I(CONSOLE_GRID_MINESHAFT_RAIL_DOWN_TO_RIGHT_2,   u8"Mineshaft Rail (down-to-right 2)"    u8" 矿洞铁轨 (下-右 2)"       )
I(CONSOLE_GRID_MINESHAFT_RAIL_DOWN_TO_LEFT_2,   u8"Mineshaft Rail (down-to-left 2)"     u8" 矿洞铁轨 (下-左 2)"       )
I(CONSOLE_GRID_MINESHAFT_RAIL_UP_TO_RIGHT_2,    u8"Mineshaft Rail (up-to-right 2)"      u8" 矿洞铁轨 (上-右 2)"       )
I(CONSOLE_GRID_MINESHAFT_RAIL_UP_TO_LEFT_2,     u8"Mineshaft Rail (up-to-left 2)"       u8" 矿洞铁轨 (上-左 2)"       )
I(CONSOLE_GRID_MINESHAFT_RAIL_HORIZONTAL_3,     u8"Mineshaft Rail (horizontal 3)"       u8" 矿洞铁轨 (横向 3)"        )
I(CONSOLE_GRID_MINESHAFT_RAIL_VERTICAL_3,       u8"Mineshaft Rail (vertical 3)"         u8" 矿洞铁轨 (纵向 3)"        )
I(CONSOLE_GRID_RAIL_PIT_HORIZONTAL,             u8"Rail Pit (horizontal)"               u8" 沟壑铁轨(横向)"           )
I(CONSOLE_GRID_RAIL_PIT_VERTICAL,               u8"Rail Pit (vertical)"                 u8" 沟壑铁轨(纵向)"           )
I(CONSOLE_GRID_RAIL_PIT_DOWN_TO_RIGHT,          u8"Rail Pit (down-to-right)"            u8" 沟壑铁轨(下-右)"          )
I(CONSOLE_GRID_RAIL_PIT_DOWN_TO_LEFT,           u8"Rail Pit (down-to-left)"             u8" 沟壑铁轨(下-左)"          )
I(CONSOLE_GRID_RAIL_PIT_UP_TO_RIGHT,            u8"Rail Pit (up-to-right)"              u8" 沟壑铁轨(上-右)"          )
I(CONSOLE_GRID_RAIL_PIT_UP_TO_LEFT,             u8"Rail Pit (up-to-left)"               u8" 沟壑铁轨(上-左)"          )
I(CONSOLE_GRID_RAIL_PIT_CROSSROAD,              u8"Rail Pit (crossroad)"                u8" 沟壑铁轨(交叉)"           )
I(CONSOLE_GRID_RAIL_PIT_CART_LEFT,              u8"Rail Pit (cart-left)"                u8" 沟壑铁轨(左开放)"         )
I(CONSOLE_GRID_RAIL_PIT_CART_UP,                u8"Rail Pit (cart-up)"                  u8" 沟壑铁轨(上开放)"         )
I(CONSOLE_GRID_RAIL_PIT_CART_RIGHT,             u8"Rail Pit (cart-right)"               u8" 沟壑铁轨(右开放)"         )
I(CONSOLE_GRID_RAIL_PIT_CART_DOWN,              u8"Rail Pit (cart-down)"                u8" 沟壑铁轨(下开放)"         )
I(CONSOLE_GRID_TELEPORTER_SQUARE,               u8"Teleporter (square)"                 u8" 传送点(方)"               )
I(CONSOLE_GRID_TELEPORTER_MOON,                 u8"Teleporter (moon)"                   u8" 传送点(月)"               )
I(CONSOLE_GRID_TELEPORTER_RHOMBUS,              u8"Teleporter (rhombus)"                u8" 传送点(菱)"               )
I(CONSOLE_GRID_TELEPORTER_M,                    u8"Teleporter (M)"                      u8" 传送点(M)"                )
I(CONSOLE_GRID_TELEPORTER_PENTAGRAM,            u8"Teleporter (pentagram)"              u8" 传送点(五角星)"           )
I(CONSOLE_GRID_TELEPORTER_CROSS,                u8"Teleporter (cross)"                  u8" 传送点(十)"               )
I(CONSOLE_GRID_TELEPORTER_TRIANGLE,             u8"Teleporter (triangle)"               u8" 传送点(三角)"             )
I(CONSOLE_GRID_TRAP_DOOR,                       u8"Trap Door"                           u8" 活板门"                   )
I(CONSOLE_GRID_VOID_PORTAL,                     u8"Void Portal"                         u8" 虚空传送门"               )
I(CONSOLE_GRID_CRAWLSPACE,                      u8"Crawlspace"                          u8" 暗门"                     )
I(CONSOLE_GRID_CRAWLSPACE_GIDEON_DUNGEON,       u8"Crawlspace (Gideon dungeon)"         u8" 暗门(基甸的洞穴)"         )
I(CONSOLE_GRID_CRAWLSPACE_SECRET_SHOP,          u8"Crawlspace (secret shop)"            u8" 暗门(地下商店)"           )
I(CONSOLE_GRID_CRAWLSPACE_STARTING_ROOM,        u8"Crawlspace (starting room)"          u8" 暗门(起始房间)"           )
I(CONSOLE_GRID_GRAVITY,                         u8"Gravity"                             u8" 重力"                    )
...
I(OPT_VIS_EFFECTS_MARK, u8"这些设置项按照ini文件中的值运作，它们不会被保存，且不应被玩家修改！")
I(OPT_VIS_ANIM_INTERP, u8"动画插帧")
I(OPT_VIS_ANIM_INTERP_MARK, u8"这个选项决定是否被启用帧的\"intermediate\". (游戏按照30FPS的逻辑帧、60FPS的动画帧运行，插帧能让它们更加“顺滑”.)")
...
I(OPT_REPENTOGON_HUSH_LASER_FIX, u8"死寂漏洞修复")
I(OPT_REPENTOGON_HUSH_LASER_FIX_MARK, u8"修复原版死寂生命值低于50%后没有攻击间隔的bug。")
I(OPT_REPENTOGON_STAT_HUD_PLANETARIUM, u8"属性界面的星象房概率")
I(OPT_REPENTOGON_STAT_HUD_PLANETARIUM_MARK, u8"在属性界面显示星象房概率。如果星象房没有解锁则无效果。")
I(OPT_REPENTOGON_SKIP_INTRO, u8"跳过简介过场")
I(OPT_REPENTOGON_SKIP_INTRO_MARK, u8"完全消除简介过场动画，不再出现\"以撒和他母亲\"。")
I(OPT_REPENTOGON_INTERPOLV2, u8"60FPS插帧")
I(OPT_REPENTOGON_INTERPOLV2_MARK, u8"在渲染间隙进行插帧，从而获得极其丝滑的动画。"/*"I am sorry for unleashing this to the world."*/)
I(OPT_REPENTOGON_FAST_LASERS, u8"快速激光(低精度)")
I(OPT_REPENTOGON_FAST_LASERS_MARK, u8"通过牺牲激光的精度来提升游戏性能，可能会轻微改变判定区(此选项减少激光的采样点数量)。")
...
I(OPT_REPENTOGON_MARSDOUBLETAP, u8"火星双击时间窗口")
I(OPT_REPENTOGON_MARSDOUBLETAP_MARK, u8"设置在使用火星道具时，触发双击冲刺所需要的输入间隔窗口。")
I(OPT_REPENTOGON_CONSOLE_AUTOFILL_LIMIT, u8"指令自动补全限制")
I(OPT_REPENTOGON_CONSOLE_AUTOFILL_LIMIT_MARK, u8"设置在控制台输入过程中出现的自动补全指令数目。将这个数字设置的很大会降低控制台打字时的性能。")
I(OPT_REPENTOGON_FILE_MAP, u8"启用模组文件映射生成")
I(OPT_REPENTOGON_FILE_MAP_MARK, u8"预检查所有模组修改过的文件以加速游戏启动并减少卡顿。如果您发现有模组资源加载问题，请关掉这个并报告给我们。")

I(OPT_REPENTOGON_ECO_MODE, u8"最小化时限制游戏")
I(OPT_REPENTOGON_ECO_MODE_MARK, u8"当游戏最小化时停止渲染并进行能耗优化。可能会影响到一些每帧都需要进行渲染的模组。")

I(OPT_REPENTOGON_DEBUG_FIND_IN_RADIUS, u8"渲染FindInRadius函数调试信息")
I(OPT_REPENTOGON_DEBUG_FIND_IN_RADIUS_MARK, u8"当标志位DebugFlag.HITSPHERES激活时, 调用函数FindInRadius/QueryRadius会渲染一个调试球。")

I(OPT_HUD_IMGUI_UI_OPTION, u8"REPENTOGON ImGui界面选项")
I(OPT_HUD_IMGUI_ENABLE_MULTIVIEW, u8"启用多视口")
I(OPT_HUD_IMGUI_ENABLE_MULTIVIEW_MARK, u8"启用后，控制台/模组的窗口可以移到游戏窗口外。")
I(OPT_HUD_FONT_SIZE, u8"字号")
I(OPT_HUD_FONT_SELECT, u8"字体选择")
I(OPT_HUD_FONT_RENDER_STYLE, u8"字体渲染风格")
I(OPT_HUD_FONT_RENDER_STYLE_PIXELATED, u8"像素渲染")
I(OPT_HUD_FONT_RENDER_STYLE_SMOOTH, u8"平滑渲染")
...
I(OPT_POPUP_MODES_OFF, u8"关")
I(OPT_POPUP_MODES_BIG, u8"大")
I(OPT_POPUP_MODES_SMALL, u8"小")
...
I(HELP_EGG_FEED_DRAGON, u8"你试着喂这只龙……")
I(HELP_EGG_LEMON, u8"你喂给这只龙一个柠檬。\n它疑惑地看着你……")
I(HELP_EGG_CARROT, u8"你喂给这只龙一根胡萝卜。\n它似乎不喜欢这个……")
I(HELP_EGG_BACON, u8"你喂给这只龙一些培根。\n它吃得很开心！")
...
I(HELP_EGG_HOWDY, u8"哈喽！是我，FLOWEY。名叫FLOWEY的花！")
I(HELP_EGG_I_OWE_YOU, u8"我欠你个大人情。你把那老蠢材打得落花流水。\n没有你，我永远都不能打败他。")
I(HELP_EGG_WITH_YOUR_HELP, u8"但是现在，有了你的帮助……")
I(HELP_EGG_HE_DEAD, u8"他死了。")
I(HELP_EGG_GOT_HUMAN_SOUL, u8"而我得到了那些人类灵魂！")
I(HELP_EGG_SOUL_INSIDE_ME_AGAIN, u8"天哪，我一直以来都是空荡荡的… 体内有个灵魂的感觉真是好呢。")
I(HELP_EGG_FELL_WRIGGLING, u8"嗯，我可以感觉到他们的颤动呢……")
I(HELP_EGG_FEELING_LEFT_OUT, u8"啊哦，你肯定觉得被冷落了，对不对？")
I(HELP_EGG_NEED_ONE_MORE_SOUL, u8"当然，那可是再好不过了。不管怎样，我只有六个灵魂。 还差一个……")
I(HELP_EGG_BEFORE_BECOME_GOD, u8"我就能成为神。")
I(HELP_EGG_POWER, u8"然后，用我新获得的力量……")
I(HELP_EGG_MONSTER, u8"怪物们……")
I(HELP_EGG_HUMAN, u8"人类们……")
I(HELP_EGG_EVERYONE, u8"所有人……")
I(HELP_EGG_SHOW_MEANING, u8"我会让他们知道 这个世界的真谛。")
