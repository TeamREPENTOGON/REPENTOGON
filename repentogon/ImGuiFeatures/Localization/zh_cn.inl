...
I(CONSOLE_COMBO_HINT_13, u8"钥匙乞丐")
...
I(OPT_CONSOLE_FADED_CONSOLE_DISPLAY, "透明控制台")
...
I(OPT_VIS_ACTIVE_CAMERA, u8"动态摄像机")
...
I(OPT_MISC_ENABLE_CTRL_HOTPLUG, "启用控制器热插拔")
...
I(OPT_REPENTOGON_HUSH_PANIC_FIX_MARK, u8"修复原版死寂生命值低于50%后攻击间隔缺失的bug。")
