...
void ASMPatchesForGetCoinValue() {
	...
	// REP+: Ultra greed doesn't freak out anymore, but these patches have been kept so that Ultra Greed will pathfind to modded coins.
	PatchSingleInlinedGetCoinValue("8b48??8d41??83f80677??8b048d????????eb??33c003f8", ASMPatch::Registers::EAX, ASMPatch::Registers::EAX, ASMPatch::SavedRegisters::Registers::EAX, 0x16, /*runCallback=*/false);
	PatchSingleInlinedGetCoinValue("8b50??8d4a", ASMPatch::Registers::EAX, ASMPatch::Registers::ECX, ASMPatch::SavedRegisters::Registers::ECX, 0x16, /*runCallback=*/false);
	...
	// Familiars
	PatchSingleInlinedGetCoinValue("8b56??8d4a??83f906", ASMPatch::Registers::ESI, ASMPatch::Registers::ECX, ASMPatch::SavedRegisters::Registers::ECX, 0x12, /*runCallback=*/true);
	// Ultra Greed
