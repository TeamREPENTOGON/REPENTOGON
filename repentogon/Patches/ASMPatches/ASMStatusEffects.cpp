...
StatusEffectPatchInfo patches[1] = {
	...
	0, ASMPatch::Registers::ECX, ASMPatch::Registers::ESI, ASMPatch::SavedRegisters::Registers::ESI, 0x28},
...
void PatchInlinedGetStatusEffectTarget()
{
	...
	for (StatusEffectPatchInfo i : patches) {
		...
		ZHL::Logger logger;
		logger.Log("Patching inlined GetStatusEffectTarget #%d at %p\n", itr, addr, i.jumpOffset);
