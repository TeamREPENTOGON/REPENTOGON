...
namespace ANM2Utils
{
    ...
    SourceQuad GetFrameSourceQuad(const AnimationFrame &frame, LayerState &layerState, const Vector &topLeftClamp, const Vector &bottomRightClamp, const ANM2 &anm2, const KAGE_Graphics_ImageBase* texture) noexcept;
