...
void zhlparserParserInitialize() {
  ...
  auto staticData = std::make_unique<ZHLParserStaticData>(
    ...
    std::vector<std::string>{
      ...
      "'__fastcall'", "'__thiscall'", "", "", "'operator'"
    },
    std::vector<std::string>{
  ...
  static const int32_t serializedATNSegment[] = {
  	4,1,87,467,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
  	...
  	99,100,5,78,0,0,100,101,5,12,0,0,101,102,5,78,0,0,102,103,5,11,0,0,103,
  	104,3,8,4,0,104,3,1,0,0,0,105,106,5,37,0,0,106,107,5,78,0,0,107,109,5,
  	...
  	5,1,0,0,0,116,117,5,38,0,0,117,118,5,79,0,0,118,127,5,3,0,0,119,120,5,
  	39,0,0,120,121,3,24,12,0,121,122,5,3,0,0,122,127,1,0,0,0,123,124,5,40,
  	0,0,124,125,5,79,0,0,125,127,5,3,0,0,126,116,1,0,0,0,126,119,1,0,0,0,
  	...
  	5,3,0,0,145,9,1,0,0,0,146,147,5,22,0,0,147,148,3,24,12,0,148,149,5,78,
  	...
  	246,7,1,0,0,246,33,1,0,0,0,247,253,5,78,0,0,248,249,5,2,0,0,249,250,5,
  	...
  	0,0,264,256,1,0,0,0,264,260,1,0,0,0,265,37,1,0,0,0,266,267,5,82,0,0,267,
  	39,1,0,0,0,268,269,7,2,0,0,269,271,5,78,0,0,270,272,3,46,23,0,271,270,
  	...
  	278,279,3,48,24,0,279,282,5,19,0,0,280,281,5,2,0,0,281,283,5,79,0,0,282,
  	...
  	5,10,0,0,301,302,5,78,0,0,302,304,5,12,0,0,303,301,1,0,0,0,304,307,1,
  	0,0,0,305,303,1,0,0,0,305,306,1,0,0,0,306,308,1,0,0,0,307,305,1,0,0,0,
  	308,309,5,78,0,0,309,310,5,11,0,0,310,47,1,0,0,0,311,318,3,50,25,0,312,
  	...
  	0,0,0,341,342,1,0,0,0,342,343,3,56,28,0,343,55,1,0,0,0,344,345,5,74,0,
  	...
  	0,360,361,5,3,0,0,361,59,1,0,0,0,362,366,5,78,0,0,363,364,5,76,0,0,364,
  	366,5,77,0,0,365,362,1,0,0,0,365,363,1,0,0,0,366,61,1,0,0,0,367,368,3,
  	...
  	0,0,0,383,381,1,0,0,0,384,385,3,68,34,0,385,386,5,2,0,0,386,387,5,79,
  	0,0,387,65,1,0,0,0,388,390,5,13,0,0,389,391,5,25,0,0,390,389,1,0,0,0,
  	390,391,1,0,0,0,391,67,1,0,0,0,392,396,5,78,0,0,393,394,5,16,0,0,394,
  	395,5,79,0,0,395,397,5,17,0,0,396,393,1,0,0,0,396,397,1,0,0,0,397,69,
  	1,0,0,0,398,399,5,74,0,0,399,403,3,8,4,0,400,401,5,75,0,0,401,403,3,10,
  	5,0,402,398,1,0,0,0,402,400,1,0,0,0,403,71,1,0,0,0,404,405,7,2,0,0,405,
  	406,5,78,0,0,406,407,5,3,0,0,407,73,1,0,0,0,408,409,5,24,0,0,409,410,
  	3,24,12,0,410,411,5,78,0,0,411,412,5,3,0,0,412,75,1,0,0,0,413,416,3,78,
  	...
  	1,0,0,0,425,423,1,0,0,0,425,426,1,0,0,0,426,427,1,0,0,0,427,428,5,78,
  	...
  	1,0,0,0,439,440,1,0,0,0,440,441,1,0,0,0,441,442,5,78,0,0,442,443,5,2,
  	0,0,443,449,5,2,0,0,444,445,5,78,0,0,445,446,5,2,0,0,446,448,5,2,0,0,
  	...
  	0,0,455,453,1,0,0,0,455,456,1,0,0,0,456,457,1,0,0,0,457,458,5,78,0,0,
...
ZHLParser::ZhlContext* ZHLParser::zhl() {
  ...
  try {
    ...
    _la = _input->LA(1);
    while ((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & 274797167104) != 0) || ((((_la - 74) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 74)) & 275) != 0)) {
      setState(90);
      _errHandler->sync(this);
...
ZHLParser::FunctionContext* ZHLParser::function() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if (((((_la - 25) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 25)) & 9007199254745085) != 0)) {
      setState(140);
      funArgs();
    }
    setState(143);
...
ZHLParser::ClassBodyContext* ZHLParser::classBody() {
  ...
  try {
    ...
    while (((((_la - 20) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 20)) & 4917930793090809763) != 0)) {
      setState(317);
      _errHandler->sync(this);
