...
namespace _func2
{
	...
	static FunctionDefinition funcObj("ANM2::SetLayerFrame", typeid(void (ANM2::*)(int , int )), "558bec8379??0056", argdata, 2, 4, &func);
}
...
namespace _func3
{
	...
	static FunctionDefinition funcObj("ANM2::ReplaceSpritesheet", typeid(void (ANM2::*)(int , const IsaacString &)), "558bec8b45??568bf185c078", argdata, 3, 5, &func);
}
