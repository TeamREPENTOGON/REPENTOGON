...
struct Room
{
	inline Camera* GetCamera() { return *(Camera**)((char*)this + 0x11F8); } // ofiginal value i found was 11F8 but comparing against hush, this seems to consistently be off by 0x40?
	...
	__declspec(align(2)) Camera *m_Camera;
};
